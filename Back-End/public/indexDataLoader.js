...
async function main() {
    ...
    product1Image.src = database[204].IMG;
    product1Name.innerText = database[204].Name;
    product1Style.innerText = database[204].Style;
    productId4.innerText = database[204].Id;
    product2Image.src = database[205].IMG;
    product2Name.innerText = database[205].Name;
    product2Style.innerText = database[205].Style;
    productId5.innerText = database[205].Id;
    product3Image.src = database[202].IMG;
    product3Name.innerText = database[202].Name;
    product3Style.innerText = database[202].Style;
    productId6.innerText = database[202].Id;
    product4Image.src = database[150].IMG;
    product4Name.innerText = database[150].Name;
    product4Style.innerText = database[150].Style;
    productId7.innerText = database[150].Id;
    product5Image.src = database[148].IMG;
    product5Name.innerText = database[148].Name;
    product5Style.innerText = database[148].Style;
    productId8.innerText = database[148].Id;
    product6Image.src = database[152].IMG;
    product6Name.innerText = database[152].Name;
    product6Style.innerText = database[152].Style;
    productId9.innerText = database[152].Id;
